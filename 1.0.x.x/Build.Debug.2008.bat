...
echo.
devenv /build debug "1Solution.2008\001.Freetime.Framework.2008.sln"
echo. 
...
echo.
devenv /build debug "1Solution.2008\002.Freetime.Data.2008.sln"
echo. 
...
echo.
devenv /build debug "1Solution.2008\003.Freetime.Util.2008.sln"
echo. 
...
echo.
devenv /build debug "1Solution.2008\004.Freetime.PluginManagement.2008.sln"
echo. 
...
echo.
devenv /build debug "1Solution.2008\005.Freetime.Data.Services.2008.sln"
echo. 
...
echo.
devenv /build debug "1Solution.2008\006.Freetime.Business.2008.sln"
echo. 
echo Done Building 005.Freetime.Data.Services.2008.sln
echo.
...
echo.
devenv /build debug "1Solution.2008\007.Freetime.Data.Services.Client.2008.sln"
echo. 
