...
echo.
devenv /build release "1Release.2010\001.Freetime.Framework.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\002.Freetime.Data.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\003.Freetime.Util.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\004.Freetime.PluginManagement.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\005.Freetime.Data.Services.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\006.Freetime.Business.2010.sln"
echo. 
echo Done Building 005.Freetime.Data.Services.2010.sln
echo.
...
echo.
devenv /build release "1Release.2010\007.Freetime.Data.Services.Client.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\008.Freetime.Web.Base.2010.sln"
echo. 
...
echo.
devenv /build release "1Release.2010\009.Freetime.Web.2010.sln"
echo. 
